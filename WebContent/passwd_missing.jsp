...
<div id="main">
  ...
  <div id="content" align="center">
     ...
     <div id="center">
      ...
      <FORM onSubmit="return checkGetPasswdForm(this);" action="member/ForgetPasswdAction!forgetPasswd.action"
      method=post>
      <TABLE width="100%" align=center border=0>
        ...
        <TR>
          ...
          <TD align=left width="60%"><INPUT class="input1" id="userName" name="userName" /> </TD></TR>
        <TR>
          <TD align=right width="40%">密码提示问题：</TD>
          <TD align=left width="60%"><INPUT class="input1" id="passwdQuestion" name="passwdQuestion" />          </TD></TR>
        <TR>
          <TD align=right width="40%">密码提示答案：</TD>
          <TD align=left width="60%"><INPUT class="input1" id="passwdAnswer" name="passwdAnswer" />        </TD></TR>
        <TR>
          <TD colSpan=2>
            <DIV align=center><INPUT style="CURSOR: pointer" type=submit value=提交 /> 
            &nbsp;&nbsp; <INPUT style="CURSOR: pointer" type=reset value=重置 /> 
          </DIV></TD></TR>
        <tr>
          <td height="13"></td>
          <td></td>
