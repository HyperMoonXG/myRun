...
<div id="main">
  ...
  <ul>
    ...
    <li><a href="messenger/inbox.jsp" title="收件箱"><span><b>收件箱</b></span></a></li>
						...
						<table width="100%">
							...
							<tbody>
								...
								<tr>
									...
									<td width="20%">
										<a href="pages/messenger/detailMessage.do?ID=161">你好</a>
									</td>
								...
								<tr>
									<td width="10%">
										<input type="checkbox" name="ID" value="162" />
									</td>
									<td width="20%">
										<a href="pages/messenger/detailMessage.do?ID=162">你好</a>
									</td>
									<td width="20%">briup3</td>
									<td width="30%">
										2007/07/27 13:11:00
								...
								<tr>
									<td width="10%">
										<input type="checkbox" name="ID" value="163" />
									</td>
									<td width="20%">
										<a href="pages/messenger/detailMessage.do?ID=163">你好</a>
									</td>
									<td width="20%">briup3</td>
									<td width="30%">
										2007/07/27 13:11:31
