...
<script type="text/javascript">
		...
		function delBuddy(){
			...
			document.forms.blackListForm.action="<%=basePath%>messenger/deleleBlack.action";
			document.forms.blackListForm.submit();		
		}	
</script>
</head>
		...
		<div id="main">
			...
			<div id="tabs1">
				<ul>
					...
					<li><a href="messenger/blackList.action" title="黑名单"><span><b>黑名单</b></span></a></li>
				</ul>
			</div>
			<br />
			<br />
							...
							<thead>
								<tr>
									...
									<td valign="bottom"><span onclick="javascript:delBuddy();">
											<img src="images/delete.gif" height="14" style="cursor: pointer"/>&nbsp;删除
									</span></td>
								</tr>
							...
							<tr>
								<td colspan="2" width="100%">
									<table width="100%">
										...
										<tbody>
											<c:forEach items="${blackList }" var="info">
											<tr>
												<th width="10%" align="center"><input type="checkbox"
													name="nickName" value="${info.nickname }" /></th>
												...
												<td width="10%" align="center"><img
													...
													onclick="window.location='messenger/deleleBlack.action?blackname=${info.nickname }'"
							...
							<li>
								<div>
									<img src="images/c.gif" /> <a
										href="messenger/listFriends.action">我的好友</a>
									<p>好友管理及黑名单</p>
								</div>
							</li>
							<li>
								<div>
									<img src="images/d.gif" /> <a
										href="messenger/member/noSpace.jsp">个性空间</a>
									<p>创建自己的个性空间</p>
								</div>
							</li>
						</ul>
