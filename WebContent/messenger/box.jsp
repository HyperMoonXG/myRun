...
<div id="main">
  ...
  <div id="tabsJ">
  <ul>
    <li><a href="sendInfo.jsp" title="Link 1"><span>写纸条</span></a></li>
    <li><a href="inbox.jsp" title="Link 2"><span>收件箱</span></a></li>
    <li><a href="outbox.jsp" title="Link 3"><span>发件箱</span></a></li>
  </ul>
</div>
<br /><br />
