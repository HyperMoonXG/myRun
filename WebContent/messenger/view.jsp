...
<div id="main">
  ...
  <ul>
    ...
    <li><a href="inbox.jsp" title="收件箱"><span><b>收件箱</b></span></a></li>
    <li><a href="outbox.jsp" title="发件箱"><span>发件箱</span></a></li>
  </ul>
</div>
<br /><br />
				...
				<tfoot>
					<tr>
						<th colspan="2" align="center" classo="line4" style="text-align:center">
							<input type="button" value="返回" onclick="self.location='messenger/inboxMessage.do'" />
						</th>
					</tr>
				</tfoot>
			</table>
