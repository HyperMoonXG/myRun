...
<div id="main">
  ...
  <ul>
    ...
    <li><a href="messenger/inbox.jsp" title="收件箱"><span>收件箱</span></a></li>
    <li><a href="messenger/outbox.jsp" title="发件箱"><span>发件箱</span></a></li>
  </ul>
  ...
  <div id="content" align="center"> 
     <div id="center"><br/><br/>
		<table width="600">
			...
			<tr>
				<td width="100%">
					<form name="sendInfoForm" action="messenger/sendInfo.action" method="post" onsubmit="return sendInfo(this);">
						<table width="100%">
						<tbody>
						<tr>
							<th width="30%" class="line1" scope="col">收信人：</th>
							<td>
								<input type="text" name="messagerecord.receiver" style="width: 250;height: 25"/>
							</td>
						</tr>
						<tr>
							<th>主题：</th>
							<td>
								<input type="text" name="messagerecord.title" style="width: 350;height: 25" />
							</td>
						</tr>
						<tr>
							<th>消息内容：</th>
							<td>
								<textarea name="messagerecord.content" rows="8" cols="55"></textarea>
							</td>
						</tr>
						</tbody>
						<tfoot>
