...
function checkMemberSpace(form){
	var opinion=form.opinion.value;
	var runtime=form.runtime.value;
	var runhabit=form.runhabit.value;
	var runstar=form.runstar.value;
	var cellphone=form.cellphone.value;
	var runplace=form.runplace.value;
	if (isEmpty(opinion)) {
		alert("\u5e26\u002a\u53f7\u7684\u9009\u9879\u5185\u5bb9\u5fc5\u987b\u586b\u5199");
		return false;
	}
