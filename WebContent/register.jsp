										...
										<TABLE width="100%">
											...
											<TBODY>
												<TR>
													...
													<TD width="30%"><INPUT maxLength=14 id="nickName" name="memberinfo.nickname"
												...
												<TR>
													...
													<TD><INPUT type=password maxLength=14
														style="width: 200px" id="passwd" name="memberinfo.password"></TD>
												...
												<TR>
													...
													<TD><INPUT type=password maxLength=14
														style="width: 200px" id="passwdre"  /></TD>
												...
												<TR>
													...
													<TD><INPUT maxLength=30 style="width: 200px" 
														id="email" name="memberinfo.email" /></TD>
												...
												<TR>
													...
													<TD><INPUT style="width: 200px" id="passwdQuestion" name="memberinfo.passwordquestion" />
													</TD>
												...
												<TR>
													...
													<TD><INPUT style="width: 200px"   id="passwdAnswer" name="memberinfo.passwordanswer" />
													</TD>
												...
												<TR>
													...
													<TD><INPUT onclick=javascript:changeText();
														type=checkbox name=re><input type="text"
															style="width: 130px; display: none" id="retext"
															name="memberinfo.recommender" /></TD>
													<TH><FONT color=#ff0000>如果有推荐人，请选择。并输入推荐人的会员ID</FONT>
													</TH>
												</TR>
												...
												<TR>
													...
													<TH><FONT color=#ff0000>请输入年龄（必须为数字）</FONT></TH>
												</TR>
												<TR>
													<TH>
												...
												<TR>
													<TH>
														<DIV align=right>手机验证：</DIV>
													</TH>
													<TD><INPUT style="width: 200px" name="memberinfo.phone" /></TD>
													<td><input  style="CURSOR: hand" type=submit value="获取验证码" name="smsver"
													 action="registerAction!smsverify.action" method=post> </input></td>
												</TR>
												<TR>
													<TH>
												...
												<TR>
													...
													<TH><IMG alt=authCode src="authImg" /></TH>
												</TR>
												<tfoot>
													<TR>
														<TD colSpan=3>
