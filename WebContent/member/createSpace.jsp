				...
				<td width="100%">
					...
					<tr>
						...
						<TD width="50%" align="left" >
							<INPUT class=INPUT1 type=text maxLength=14 value="${member.memberSpace.opinion }"
							 name="opinion" style="width:200;height:25" />						</TD>
					</tr>
					<TR>
						<TD width="50%" align="right">
							<FONT color=#ff9933>*</FONT> 喜欢在什么时段跑步？						</TD>
						<TD width="50%" align="left">
									<input type="radio" id="runtime" name="runtime" class=radio1 value="清晨" />清晨
									<input type="radio" id="runtime" name="runtime" class=radio1 value="午后" />午后
									<input type="radio" id="runtime" name="runtime" class=radio1	value="黄昏"/>黄昏						
						<script>  
          			  		initradio('runtime',"${member.memberSpace.runtime }");  
       					 </script>
						</TD>
					</TR>
					<TR>
						...
						<TD width="50%" align="left">
							<input type="radio" id="runhabit" name="runhabit" class=radio1 value="独自" />独自
							<input type="radio" id="runhabit" name="runhabit" class=radio1 value="结伴" />结伴
							<script>  
          			  		initradio('runhabit',"${member.memberSpace.runhabit }");  
       						</script>
						</TD>
					</TR>
					<TR>
						...
						<TD align="left">
							<INPUT class=INPUT1 type=text maxLength=20 id="runstar" name="runstar"	 style="width:200;height:25" 
							value="${member.memberSpace.runstar }" />						
						</TD>
					</TR>
					<TR>
						<TD width="50%" align="right">
						...
						<TD width="50%" align="left">
							<INPUT class=INPUT1 type=text maxLength=14 id="cellphone" name="cellphone"
							style="width:200;height:25" value="${member.memberSpace.cellphone }" />						
						</TD>
					</TR>
					<TR>
						<TD width="50%" align="right">
						...
						<TD width="50%" align="left">
							<INPUT class="INPUT1" type="text" maxLength="14" id="runplace" name="runplace"
							style="width:200;height:25" value="${member.memberSpace.runplace }" />						
						</TD>
					</TR>
					<TR>
