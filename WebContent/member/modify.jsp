     ...
     <div id="center">
		...
		<table width="600">
			<thead>
  			...
  			<tr>
				<td width="100%">
					<form  action="member/ModifyAction!modify.action" method="post" onSubmit="return validateModifyForm(this);">
					...
					<tr>
						...
						<td width="30%" >
							<input type="text" maxLength="14" style="width:200px" name="nickName" value="${sessionScope.member.nickname }" disabled />
						</td>
						<th width="45%" >
					...
					<tr>
						...
						<td>
							<input type="text" maxLength="30" style="width:200px" name="email"  value="${sessionScope.member.email }" />
						</td>
						<th>
					...
					<tr>
						...
						<th>
							<input style="width:200px" type="text" name="passwdQuestion" value="${sessionScope.member.passwordquestion }"/>
						</th>
						<th>
					...
					<tr>
						...
						<td>
							<input  type="text" style="width:200px" name="passwdAnswer" value="${sessionScope.member.passwordanswer }"/>
						</td>
						<th>
					...
					<tr>
						...
						<script>  
          			  		initradio('gender',"${sessionScope.member.gender }");  
       					 </script> 
						</td>
						<th>&nbsp;	</th>
					</tr>
					<tr>
						...
						<td ><%-- ${sessionScope.member.provincecity+0 } --%>
					...
					<tr>
						...
						<td>
							<input type="text" style="width:200px" name="phone" value="${sessionScope.member.phone }"/>
						</td>
						<th>
					...
					<tr>
						...
						<td>
							<input type="text" style="width:200px" name="address" value="${sessionScope.member.address }"/>
						</td>
						<th>&nbsp;</th>
					</tr>
					<tfoot>
