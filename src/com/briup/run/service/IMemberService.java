...
public interface IMemberService {
	...
	// 保存加积分的记录
	void saveOrUpdatePointrecord(Pointrecord pointrecord) throws MemberServiceException;
	
	// 保存用户空间
	void saveOrUpdateSpace(Memberspace memberspace) throws MemberServiceException;
	//查找个人空间
